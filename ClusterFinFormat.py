...
for i in range(0, parts**2):
    ...
    fname = "C:/Users/sammy/Downloads/SEM/SEM/PFD_Fin_Masks/Masks"+str(testIndex)+".csv"
    output = open(fname, 'wb')
    pickle.dump(masks, output)
    output.close()
    fname = "C:/Users/sammy/Downloads/SEM/SEM/PFD_Fin_boxes/boxes"+str(testIndex)+".csv"
